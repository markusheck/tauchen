...
public class WicketApplication extends AuthenticatedWebApplication {
	 ...
	 */
	@Override
	public Class<Basisinfo> getHomePage() {
		return Basisinfo.class;
	}
	...
	protected void init() {
		...
		System.out.println( "Classloader: " + sysClassLoader );
	    URL url = sysClassLoader.getResource( "com.cooldatasoft.common.MenuItem".replace('.', '/' ) + ".class" );
	    ...
	    getApplicationSettings().setPageExpiredErrorPage(LoginPageWicket6.class);
	    scanAnnotations();
